...
public class ResaTopoManagerImpl extends AbstractManagerImpl implements ResaTopoManager {
    ...
    public ResaTopo addResaTopo(ResaTopo resaTopo, Compte compte) {
        ...
        /**@see org.escalade.consumer.impl.dao.ResaTopoImpl#addResaTopo(ResaTopo, Compte)*/
        getDaoFactory().getResaTopoDao().addResaTopo(resaTopo, compte);

        /**@see org.escalade.consumer.impl.dao.ResaTopoImpl#recoversIdResaTopoDao(ResaTopo, Compte)*/
    ...
    public List<ResaTopo> resaTopoListByTopoAccount(Compte compte){
        ...
        /**@see org.escalade.consumer.impl.dao.ResaTopoImpl#resaTopoListByTopoAccountDao(Compte)*/
        ...
        for (ResaTopo resaTopo : vResaTopoListTemp){
             ...
             * @see org.escalade.consumer.impl.dao.MessagerieImpl#messageListResaTopoDao(Integer)
             */
    ...
    public List<ResaTopo> resaTopoListByAccount(Compte compte){
        ...
        /**@see org.escalade.consumer.impl.dao.ResaTopoImpl#resaTopoListByAccountDao(Compte)*/
