    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="form-group">
                ...
                <input id="inputNomSite" name="modifySite.nom" value="${site.nom}" class="form-control" required="true"/>
            </div>
            <div class="form-group">
                <label for="selectRegion" requiredLabel="true">Régions</label>
                <select id="selectRegion" name="modifySite.region" required="true" class="form-control">
            ...
            <div class="form-group">
                ...
                <textarea name="modifySite.description" id="textareaDescriptionSite" rows="5" class="form-control"
