...
public class PhotoManagerImpl extends AbstractManagerImpl implements PhotoManager {
    ...
    public void addPhoto(Topo topo, String nomPhoto, String url_image) {
        ...
        /**@see org.escalade.consumer.impl.dao.PhotoImpl#addPhotoTopo(Topo, String, String)*/
    ...
    public void delPhotoTopo(Integer topo_id) {
        ...
        /**@see org.escalade.consumer.impl.dao.PhotoImpl#delPhotoTopoDao(Integer)*/
    ...
    public void upPhoto(Photo photo){
        ...
        /**@see org.escalade.consumer.impl.dao.PhotoImpl#upPhotoDao(Photo)*/
    ...
    public List<Photo> listPhotosByTopos(List<Topo> topoList){
        ...
        for (Topo topo : topoList){
            ...
            /**@see org.escalade.consumer.impl.dao.PhotoImpl#listPhotosByToposDao(Topo)*/
    ...
    public Photo photoByTopo (Topo topo){
        /**@see org.escalade.consumer.impl.dao.PhotoImpl#photoByTopo(Topo)*/
